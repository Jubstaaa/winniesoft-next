...
function privacyPolicy() {
  return (
    <section className="project-details">
      <Head>
        <title>Privacy and Policy | WinnieSoft</title>
        <meta charset="utf-8" />
      ...
      <div className="container">
        ...
        <p>
          WinnieSoft built the Circle Base app as a Free app. This SERVICE is
          provided by WinnieSoft at no cost and is intended for use as is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at Circle Base unless
        ...
        <p>This policy is effective as of 2022-02-26</p>{" "}
        <p>
          <strong>Contact Us</strong>
        </p>{" "}
        <p>
          If you have any questions or suggestions about my Privacy Policy, do
          not hesitate to contact me at info@winniesoft.com.
        </p>{" "}
        <p>
